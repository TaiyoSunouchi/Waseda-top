  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-0 z-[2000] bg-black/40 transition-opacity ${
      ...
      {/* サイドメニュー本体 */}
      <nav
        className={`fixed top-0 left-0 z-[2001] h-full w-72 bg-white text-black border-r shadow-lg transition-transform ${
        ...
        <ul className="p-2">
          <li>
            <Link
              href="/"
              onClick={() => setOpen(false)}
              className="block px-3 py-2 rounded hover:bg-black/5 text-black"
            >
              ホーム
            </Link>
          </li>
